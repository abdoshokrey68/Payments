    ...
    */
    ...
    'paths' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | app folder name - empty = classes at module root (Http/, Providers/, etc.)
        | for example can change it to 'src' or 'App' or '' for root
        */
        'app_folder' => '',
        ...
        */
        'generator' => [
            // Module root (no app/ folder - matches "Modules\\": "Modules/" in composer)
            ...
            // database/ (capital D for PSR-4: Modules\Module\Database\Seeders)
